...
1. computes the semantic distance (e.g., Word Mover's Distance) between the original response and each perturbed prompt. XWhy supports various distances like `wmd` (default), `wassertein`, `cosine`, `anderson_darling`, etc.;
...
The [LLM explainer overview](https://dependable-intelligent-systems-lab.github.io/xwhy/explainers/llm/index.md) summarises the capability, and the [API reference](https://dependable-intelligent-systems-lab.github.io/xwhy/reference/xwhy/explainers/llm/index.md) provides the implementation interface.
