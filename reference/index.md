...
| [`xwhy.PointCloudExplainer`](https://dependable-intelligent-systems-lab.github.io/xwhy/reference/generated/xwhy/PointCloudExplainer/index.md)                               | Explainer for Point Cloud classification tasks.                            |
...
| [`xwhy.core.ImageGenerationAndEditingConfig`](https://dependable-intelligent-systems-lab.github.io/xwhy/reference/generated/xwhy/core/ImageGenerationAndEditingConfig/index.md) | Configuration for the Image Generation and Editing explainer. |
...
| [`xwhy.core.PointCloudConfig`](https://dependable-intelligent-systems-lab.github.io/xwhy/reference/generated/xwhy/core/PointCloudConfig/index.md)                               | Configuration for the Point Cloud explainer.                  |
...
| [`xwhy.core.TextConfig`](https://dependable-intelligent-systems-lab.github.io/xwhy/reference/generated/xwhy/core/TextConfig/index.md)                                           | Configuration for the Text explainer.                         |
...
| [`xwhy.plots.create_clean_3d_layout`](https://dependable-intelligent-systems-lab.github.io/xwhy/reference/generated/xwhy/plots/create_clean_3d_layout/index.md)           | Create a minimal 3D Plotly layout without axes clutter.                    |
| [`xwhy.plots.create_point_cloud_trace`](https://dependable-intelligent-systems-lab.github.io/xwhy/reference/generated/xwhy/plots/create_point_cloud_trace/index.md)       | Create a Plotly 3D scatter trace for point cloud visualization.            |
| [`xwhy.plots.create_rotation_frames`](https://dependable-intelligent-systems-lab.github.io/xwhy/reference/generated/xwhy/plots/create_rotation_frames/index.md)           | Generate camera rotation frames for 3D Plotly animations.                  |
...
| [`xwhy.plots.display_plotly_figure`](https://dependable-intelligent-systems-lab.github.io/xwhy/reference/generated/xwhy/plots/display_plotly_figure/index.md)             | Display a Plotly figure to persist after reopening a Jupyter notebook.     |
...
| [`xwhy.plots.Explanation`](https://dependable-intelligent-systems-lab.github.io/xwhy/reference/generated/xwhy/plots/Explanation/index.md)                                 | Public XWhy API object `Explanation`.                                      |
...
| [`xwhy.plots.plot_3d_mesh`](https://dependable-intelligent-systems-lab.github.io/xwhy/reference/generated/xwhy/plots/plot_3d_mesh/index.md)                               | Create a 3D mesh visualization with a rotation animation.                  |
| [`xwhy.plots.plot_3d_point_cloud`](https://dependable-intelligent-systems-lab.github.io/xwhy/reference/generated/xwhy/plots/plot_3d_point_cloud/index.md)                 | Create a 3D point cloud visualization with a rotation animation.           |
| [`xwhy.plots.plot_colored_3d_point_cloud`](https://dependable-intelligent-systems-lab.github.io/xwhy/reference/generated/xwhy/plots/plot_colored_3d_point_cloud/index.md) | Create a colored 3D point cloud visualization with rotation.               |
...
| [`xwhy.plots.plot_point_cloud`](https://dependable-intelligent-systems-lab.github.io/xwhy/reference/generated/xwhy/plots/plot_point_cloud/index.md)                       | Visualize explanation over point cloud by highlighting important clusters. |
| [`xwhy.plots.plot_point_cloud_clusters`](https://dependable-intelligent-systems-lab.github.io/xwhy/reference/generated/xwhy/plots/plot_point_cloud_clusters/index.md)     | Visualize clustered point cloud segments in 3D.                            |
...
| [`xwhy.distance.WMDDistance`](https://dependable-intelligent-systems-lab.github.io/xwhy/reference/generated/xwhy/distance/WMDDistance/index.md)                         | Word Mover's Distance metric for raw text strings.                      |
