...
This page is generated from XWhy's published [GitHub Releases](https://github.com/Dependable-Intelligent-Systems-Lab/xwhy/releases). Each documentation build refreshes the summary table and the detailed notes below, so a new release does not require a manual documentation edit.

## Release history

| Release                                                                                                | Released          | Type        | Notes                                |
| ------------------------------------------------------------------------------------------------------ | ----------------- | ----------- | ------------------------------------ |
| [v0.0.4](https://github.com/Dependable-Intelligent-Systems-Lab/xwhy/releases/tag/v0.0.4)               | 24 September 2026 | Stable      | [Read notes](#release-v0-0-4)        |
| [v0.0.3-alpha](https://github.com/Dependable-Intelligent-Systems-Lab/xwhy/releases/tag/v0.0.3-alpha)   | 13 August 2026    | Pre-release | [Read notes](#release-v0-0-3-alpha)  |
...
For work merged since the latest release, see [`v0.0.4...main`](https://github.com/Dependable-Intelligent-Systems-Lab/xwhy/compare/v0.0.4...main).

The complete notes for each release follow.

## v0.0.4

Released 24 September 2026 · Stable release · [GitHub release](https://github.com/Dependable-Intelligent-Systems-Lab/xwhy/releases/tag/v0.0.4) · [PyPI](https://pypi.org/project/xwhy/)

## What's Changed Varous parts have been updated as follows: ### Other changes * Improve XWhy mobile performance, accessibility, and agentic browsing by @koo-ec in

[Dependable-Intelligent-Systems-Lab/xwhy#66](https://github.com/Dependable-Intelligent-Systems-Lab/xwhy/pull/66) * Enable PageSpeed audits on workflow pull requests by @koo-ec in [Dependable-Intelligent-Systems-Lab/xwhy#67](https://github.com/Dependable-Intelligent-Systems-Lab/xwhy/pull/67) * Add Image generation and editing explainer - alpha version by @HamedDaneshvar in [Dependable-Intelligent-Systems-Lab/xwhy#71](https://github.com/Dependable-Intelligent-Systems-Lab/xwhy/pull/71) * Add unittest for Image generation and editing explainer by @HamedDaneshvar in [Dependable-Intelligent-Systems-Lab/xwhy#73](https://github.com/Dependable-Intelligent-Systems-Lab/xwhy/pull/73) * Automate release notes and API reference by @koo-ec in [Dependable-Intelligent-Systems-Lab/xwhy#69](https://github.com/Dependable-Intelligent-Systems-Lab/xwhy/pull/69) * Replace SHAP plotting with a native visualisation engine by @koo-ec in [Dependable-Intelligent-Systems-Lab/xwhy#70](https://github.com/Dependable-Intelligent-Systems-Lab/xwhy/pull/70) * fix build dependencies for shap plots and add some validation and warning for explainers by @HamedDaneshvar in [Dependable-Intelligent-Systems-Lab/xwhy#74](https://github.com/Dependable-Intelligent-Systems-Lab/xwhy/pull/74) * Add NLP explainer and full coverage test code by @HamedDaneshvar in [Dependable-Intelligent-Systems-Lab/xwhy#75](https://github.com/Dependable-Intelligent-Systems-Lab/xwhy/pull/75) * Validate inf/nan for distances and retry mechanism for providers by @HamedDaneshvar in [Dependable-Intelligent-Systems-Lab/xwhy#76](https://github.com/Dependable-Intelligent-Systems-Lab/xwhy/pull/76) * Revise Pix2Pix documentation for clarity and scope by @Sara068 in [Dependable-Intelligent-Systems-Lab/xwhy#77](https://github.com/Dependable-Intelligent-Systems-Lab/xwhy/pull/77) * Add point cloud explainer by @HamedDaneshvar in [Dependable-Intelligent-Systems-Lab/xwhy#78](https://github.com/Dependable-Intelligent-Systems-Lab/xwhy/pull/78) * Refactor some part of code by @HamedDaneshvar in [Dependable-Intelligent-Systems-Lab/xwhy#79](https://github.com/Dependable-Intelligent-Systems-Lab/xwhy/pull/79) **Full Changelog**: https://github.com/Dependable-Intelligent-Systems-Lab/xwhy/compare/v0.0.3...v0.0.4
...
- Add unittest for Image generation and editing explainer by @HamedDaneshvar in https://github.com/Dependable-Intelligent-Systems-Lab/xwhy/pull/73
- Automate release notes and API reference by @koo-ec in https://github.com/Dependable-Intelligent-Systems-Lab/xwhy/pull/69
- Replace SHAP plotting with a native visualisation engine by @koo-ec in https://github.com/Dependable-Intelligent-Systems-Lab/xwhy/pull/70
- fix build dependencies for shap plots and add some validation and warning for explainers by @HamedDaneshvar in https://github.com/Dependable-Intelligent-Systems-Lab/xwhy/pull/74
- Add NLP explainer and full coverage test code by @HamedDaneshvar in https://github.com/Dependable-Intelligent-Systems-Lab/xwhy/pull/75
- Validate inf/nan for distances and retry mechanism for providers by @HamedDaneshvar in https://github.com/Dependable-Intelligent-Systems-Lab/xwhy/pull/76
- Revise Pix2Pix documentation for clarity and scope by @Sara068 in https://github.com/Dependable-Intelligent-Systems-Lab/xwhy/pull/77
- Add point cloud explainer by @HamedDaneshvar in https://github.com/Dependable-Intelligent-Systems-Lab/xwhy/pull/78
- Refactor some part of code by @HamedDaneshvar in https://github.com/Dependable-Intelligent-Systems-Lab/xwhy/pull/79

**Full Changelog**: https://github.com/Dependable-Intelligent-Systems-Lab/xwhy/compare/v0.0.3...v0.0.4

## v0.0.3-alpha

Released 13 August 2026 · Pre-release · [GitHub release](https://github.com/Dependable-Intelligent-Systems-Lab/xwhy/releases/tag/v0.0.3-alpha) · [PyPI](https://pypi.org/project/xwhy/)
