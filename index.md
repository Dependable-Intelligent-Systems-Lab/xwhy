...
XWhy `v0.0.4` is currently classified as **pre-alpha**. Image Classification, Image Generation & Editing, LLM, Tabular, and Text explainers are implemented. Point Cloud remains a development interface, while Time Series, Multimodal, Agentic AI, and Multi-Agent AI are planned capabilities.
