...
1. **Between-agent explanation** — how communication or dependency between agents influenced subsequent behaviour.
1. **System-level explanation** — how the combined agent network produced the final outcome.
