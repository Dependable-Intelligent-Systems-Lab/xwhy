...
Use [`LLMExplainer`](https://dependable-intelligent-systems-lab.github.io/xwhy/explainers/llm/index.md) when the target behaviour is the relationship between an LLM prompt and its generated response.
...
[View the current API reference](https://dependable-intelligent-systems-lab.github.io/xwhy/reference/xwhy/explainers/text/index.md)
