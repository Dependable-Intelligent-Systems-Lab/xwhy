...
!!! success "Available"
    `LLMExplainer` is implemented and has a complete provider and usage guide.
...
- token-level and contribution plots.

[Read the complete LLM tutorial](../../llm_explainer.md)

[Open the worked LLM example](../../examples/llm-explainer.md)
