---
title: XWhy Agentic AI Explainability
description: Planned XWhy support for explaining agentic AI workflows, including planning, retrieval, memory, tool use, actions, state transitions, and uncertainty or failure propagation.
---
